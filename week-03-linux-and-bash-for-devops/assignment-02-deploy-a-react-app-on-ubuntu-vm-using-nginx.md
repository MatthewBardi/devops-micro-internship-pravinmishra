...
![Screenshot 1 — Node.js and npm versions](screenshots/assignment-02-screenshot-01-node-npm-versions.png)
...
![Screenshot 2 — Nginx running](screenshots/assignment-02-screenshot-02-nginx-running.png)
...
![Screenshot 3 — React project files](screenshots/assignment-02-screenshot-03-react-project-files.png)
...
![Screenshot 4 — App.js personalization](screenshots/assignment-02-screenshot-04-app-personalization.png)
...
![Screenshot 5 — React production build folder](screenshots/assignment-02-screenshot-05-build-folder.png)
...
![Screenshot 6 — React build deployed to Nginx web root](screenshots/assignment-02-screenshot-06-nginx-web-root-files.png)
...
![Screenshot 7 — Nginx active](screenshots/assignment-02-screenshot-07-nginx-active.png)

---

#### Screenshot 8 — Output of `cat /etc/nginx/sites-available/default` showing the Nginx config

![Screenshot 8 — Nginx configuration](screenshots/assignment-02-screenshot-08-nginx-config.png)
...
![Screenshot 9 — EC2 public IP](screenshots/assignment-02-screenshot-09-public-ip.png)

---

#### Screenshot 10 — Browser showing the deployed React app at `http://<public-ip>` with your name and date visible

![Screenshot 10 — React app running in browser](screenshots/assignment-02-screenshot-10-react-app-browser.png)
...
https://www.linkedin.com/posts/matthew-bardi_aws-cloudcomputing-linux-share-7483234610626125824-L_WP/?utm_source=share&utm_medium=member_desktop&rcm=ACoAABp_eQgBPlJcA09mSDh9Dmz_Fnr6k9cADN8

---

#### Screenshot — LinkedIn post showing the deployed application

![LinkedIn post showing the deployed React application](screenshots/assignment-02-linkedin-post.png)
