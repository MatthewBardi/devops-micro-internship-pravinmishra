...
![Nginx service active and running](screenshots/assignment-04-screenshot-00-nginx-status.png)
...
![Extracted portfolio project folder](screenshots/assignment-04-screenshot-01-extracted-folder.png)
...
![Footer updated with ownership details](screenshots/assignment-04-screenshot-02-footer-update.png)
...
![Nginx configuration test successful](screenshots/assignment-04-screenshot-03-nginx-test.png)

---

#### Screenshot 4 — Output of `ls /var/www/html` showing deployed website files

![Deployed website files in the Nginx web root](screenshots/assignment-04-screenshot-04-web-root-files.png)
...
![Server public IP address](screenshots/assignment-04-screenshot-05-public-ip.png)

---

#### Screenshot 6 — Browser showing the live website with your Full Name and deployment details in the footer

![Live portfolio website with ownership footer](screenshots/assignment-04-screenshot-06-live-website-footer.png)
...
![Nginx enabled on boot](screenshots/assignment-04-screenshot-07-nginx-enabled.png)

---

#### Screenshot 8 — Output of `curl -I http://localhost` showing 200 OK

![Local HTTP response returning 200 OK](screenshots/assignment-04-screenshot-08-local-http-200.png)
...
https://www.linkedin.com/posts/matthew-bardi_dmibypravinmishra-devops-agenticai-share-7483640058361585664-ls5o/?utm_source=share&utm_medium=member_desktop&rcm=ACoAABp_eQgBPlJcA09mSDh9Dmz_Fnr6k9cADN8`

---

#### Screenshot — Published LinkedIn post showing the live website with your Full Name in the footer

![Assignment 4 LinkedIn Post](screenshots/assignment-04-linkedin-post.png)
