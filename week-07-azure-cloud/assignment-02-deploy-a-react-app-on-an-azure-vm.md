...
![Resource Group overview](screenshots/assignment-02-01-resource-group-overview.png)
...
![Azure VM overview](screenshots/assignment-02-02-vm-overview.png)

---

#### Screenshot 3 — Network Security Group inbound rules showing ports 22 and 80 allowed

![NSG inbound rules](screenshots/assignment-02-03-nsg-inbound-rules.png)
...
![Successful SSH login](screenshots/assignment-02-04-ssh-login.png)
...
![Node.js and npm versions](screenshots/assignment-02-05-node-npm-versions.png)
...
![Successful React production build](screenshots/assignment-02-06-react-build.png)
...
![Successful Nginx configuration test](screenshots/assignment-02-07-nginx-test.png)

---

#### Screenshot 8 — Nginx configuration snippet showing the build root and `try_files` directive

![Nginx React SPA configuration](screenshots/assignment-02-08-nginx-config.png)
...
![Live React application](screenshots/assignment-02-09-live-react-app.png)
...
*Optional Screenshot 10 not included. SSH was restricted to my IP and UFW was verified not to block HTTP.*
