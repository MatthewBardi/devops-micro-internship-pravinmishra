...
![Private team-managed Scrum project](./screenshots/Assignment2-Screenshot1.png)
...
![Epic visible in the Jira Backlog](./screenshots/Assignment2-Screenshot2.png)
...
![Epic and all six Stories in the Backlog](./screenshots/Assignment2-Screenshot3.png)

---

#### Screenshot 4 — One opened Story showing its Story point estimate, acceptance criteria, and label

![Story details showing acceptance criteria, label, and story points](./screenshots/Assignment2-Screenshot4.png)
...
![S2 showing all four subtasks](./screenshots/Assignment2-Screenshot5.png)

---

#### Screenshot 6 — S4 showing all four Sub-tasks

![S4 showing all four subtasks](./screenshots/Assignment2-Screenshot6.png)
...
![Frontend-labelled Stories shown through filtering](./screenshots/Assignment2-Screenshot7.png)
...
![Sprint 1 before starting with selected Stories and story points](./screenshots/Assignment2-Screenshot8.png)

---

#### Screenshot 9 — Active Sprint board showing the started Sprint and Sprint Goal

![Active Sprint 1 with the Sprint Goal](./screenshots/Assignment2-Screenshot9.png)
...
![Frontend label filter results](./screenshots/Assignment2-Screenshot10.png)

---

#### Screenshot 11 — Filter for label = devops showing the filtered results

![DevOps label filter results](./screenshots/Assignment2-Screenshot11.png)
...
![Sprint 1 burndown chart](./screenshots/Assignment2-Screenshot12.png)
