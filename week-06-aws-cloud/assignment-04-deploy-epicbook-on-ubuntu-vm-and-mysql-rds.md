...
![Screenshot 1](screenshots/week-06-assignment-04-screenshot-01-vpc-details.png)

---

#### Screenshot 2 — Subnets list showing both subnets and their CIDRs

![Screenshot 2](screenshots/week-06-assignment-04-screenshot-02-subnets.png)

---

#### Screenshot 3 — Route table showing 0.0.0.0/0 → IGW and association with the public subnet

![Screenshot 3](screenshots/week-06-assignment-04-screenshot-03-public-route-table.png)
...
![Screenshot 4](screenshots/week-06-assignment-04-screenshot-04-ec2-security-group.png)

---

#### Screenshot 5 — RDS security-group inbound rule showing MySQL 3306 allowed from the EC2 security group

![Screenshot 5](screenshots/week-06-assignment-04-screenshot-05-rds-security-group.png)
...
![Screenshot 6](screenshots/week-06-assignment-04-screenshot-06-ec2-summary.png)

---

#### Screenshot 7 — Terminal showing a successful SSH login with the `ubuntu@...` prompt

![Screenshot 7](screenshots/week-06-assignment-04-screenshot-07-ssh-login.png)
...
![Screenshot 8](screenshots/week-06-assignment-04-screenshot-08-node-npm-versions.png)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![Screenshot 9](screenshots/week-06-assignment-04-screenshot-09-nginx-status.png)

---

#### Screenshot 10 — Output of `mysql --version`

![Screenshot 10](screenshots/week-06-assignment-04-screenshot-10-mysql-version.png)
...
![Screenshot 11](screenshots/week-06-assignment-04-screenshot-11-rds-private.png)

---

#### Screenshot 12 — Connectivity & security section showing the VPC and attached security group

![Screenshot 12](screenshots/week-06-assignment-04-screenshot-12-rds-connectivity-security.png)
...
![Screenshot 13](screenshots/week-06-assignment-04-screenshot-13-show-tables.png)
...
![Screenshot 14](screenshots/week-06-assignment-04-screenshot-14-epicbook-repository.png)

---

#### Screenshot 15 — Terminal showing the backend running, or `ss -tulpn` showing the port open

![Screenshot 15](screenshots/week-06-assignment-04-screenshot-15-backend-port-3000.png)

---

#### Screenshot 16 — `curl` output proving the backend responds; a 200, 301, or 404 response is acceptable if the service responds

![Screenshot 16](screenshots/week-06-assignment-04-screenshot-16-backend-curl.png)
...
![Screenshot 17](screenshots/week-06-assignment-04-screenshot-17-nginx-test.png)

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![Screenshot 18](screenshots/week-06-assignment-04-screenshot-18-nginx-reverse-proxy.png)
...
![Screenshot 19](screenshots/week-06-assignment-04-screenshot-19-epicbook-browser.png)

---

#### Screenshot 20 — Terminal showing a successful API call through the public endpoint, such as `curl http://<EC2_PUBLIC_IP>/api/...`

![Screenshot 20](screenshots/week-06-assignment-04-screenshot-20-public-api-call.png)

---

#### Screenshot 21 — Terminal showing the successful database connectivity test using `SELECT 1;` or similar

![Screenshot 21](screenshots/week-06-assignment-04-screenshot-21-database-select-1.png)
