...
![Screenshot 1 - Clean master branch and repository status](screenshots/Assignment3-Screenshot1.png)
...
![Screenshot 2 - Feature contact page branch created and checked out](screenshots/Assignment3-Screenshot2.png)
...
![Screenshot 3 - contact.html created on the feature branch](screenshots/Assignment3-Screenshot3.png)

---

#### Screenshot 4 — Output of `git commit`

![Screenshot 4 - Contact page committed on the feature branch](screenshots/Assignment3-Screenshot4.png)

---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![Screenshot 5 - Recent Git history showing the Contact page commit](screenshots/Assignment3-Screenshot5.png)
...
![Screenshot 6 - Git status showing index.html as modified](screenshots/Assignment3-Screenshot6.png)

---

#### Screenshot 7 — Output of `git commit`

![Screenshot 7 - Navigation link committed on the feature branch](screenshots/Assignment3-Screenshot7.png)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![Screenshot 8 - Contact Page link visible on the feature branch](screenshots/Assignment3-Screenshot8.png)
...
![Screenshot 9 - Master branch checked out with contact.html absent](screenshots/Assignment3-Screenshot9.png)

---

#### Screenshot 10 — Browser showing the homepage on the default branch with no Contact Page link

![Screenshot 10 - Homepage on master branch without the Contact Page link](screenshots/Assignment3-Screenshot10.png)
...
![Screenshot 11 - Feature branch merged into master](screenshots/Assignment3-Screenshot11.png)

---

#### Screenshot 12 — Output of `ls` showing `contact.html` after the merge

![Screenshot 12 - contact.html visible on master after the merge](screenshots/Assignment3-Screenshot12.png)

---

#### Screenshot 13 — Browser showing the Contact page opened from the homepage link on the default branch

![Screenshot 13 - Contact page opened successfully after the merge](screenshots/Assignment3-Screenshot13.png)
...
![Screenshot 14 - Git graph showing both feature commits and branch history](screenshots/Assignment3-Screenshot14.png)
...
![Screenshot 15 - Feature branch deleted after merge](screenshots/Assignment3-Screenshot15.png)
