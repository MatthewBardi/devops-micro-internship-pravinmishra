...
![Screenshot 1 - CodeTrack repository location](screenshots/Assignment2-Screenshot1.png)

---

#### Screenshot 2 — Output of `git status` showing no "not a git repository" error

![Screenshot 2 - Git status confirms CodeTrack is a valid repository](screenshots/Assignment2-Screenshot2.png)
...
![Screenshot 3 - index.html and style.css created inside CodeTrack](screenshots/Assignment2-Screenshot3.png)
...
![Screenshot 4 - Starter HTML and CSS content shown in VS Code](screenshots/Assignment2-Screenshot4.png)
...
![Screenshot 5 - index.html and style.css shown as untracked files](screenshots/Assignment2-Screenshot5.png)

---

#### Screenshot 6 — Output of `git status` showing both files staged under "Changes to be committed"

![Screenshot 6 - index.html and style.css staged for commit](screenshots/Assignment2-Screenshot6.png)
...
![Screenshot 7 - First Git commit created successfully](screenshots/Assignment2-Screenshot7.png)

---

#### Screenshot 8 — Output of `git log --oneline` showing the first commit

![Screenshot 8 - Git log showing the first commit](screenshots/Assignment2-Screenshot8.png)
...
![Screenshot 9 - Updated CodeTrack page showing full name and group number](screenshots/Assignment2-Screenshot9.png)

---

#### Screenshot 10 — Output of `git status` showing `index.html` as modified

![Screenshot 10 - Git status showing index.html as modified](screenshots/Assignment2-Screenshot10.png)

---

#### Screenshot 11 — Output of `git commit`

![Screenshot 11 - Second Git commit created successfully](screenshots/Assignment2-Screenshot11.png)

---

#### Screenshot 12 — Output of `git log --oneline` showing two commits

![Screenshot 12 - Git log showing both meaningful commits](screenshots/Assignment2-Screenshot12.png)
...
![Screenshot 13 - Nginx service active and running on EC2](screenshots/Assignment2-Screenshot13.png)

---

#### Screenshot 14 — Output of `curl -I http://localhost` showing `HTTP/1.1 200 OK`

![Screenshot 14 - Localhost request returns HTTP 200 from Nginx](screenshots/Assignment2-Screenshot14.png)

---

#### Screenshot 15 — Browser showing the CodeTrack site loaded at `http://<EC2_PUBLIC_IP>`, with your Full Name and Group Name visible

![Screenshot 15 - CodeTrack deployed on EC2 with full name and group number visible](screenshots/Assignment2-Screenshot15.png)
...
https://www.linkedin.com/posts/share-7485805517173325824-Fglv/?utm_source=share&utm_medium=member_desktop&rcm=ACoAABp_eQgBPlJcA09mSDh9Dmz_Fnr6k9cADN8

---

#### Screenshot — LinkedIn post showing the deployed CodeTrack application

![LinkedIn post showing the deployed CodeTrack application](screenshots/Assignment2-LinkedInPost.png)
