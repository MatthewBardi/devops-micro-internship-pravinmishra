...
![Screenshot 1 - GitHub fork showing username and repository URL](screenshots/Assignment5-Screenshot1.png)
...
![Screenshot 2 - Git Credential Manager configured](screenshots/Assignment5-Screenshot2.png)
...
![Screenshot 3 - Origin and upstream remotes configured](screenshots/Assignment5-Screenshot3.png)
...
![Screenshot 4 - pull_request.md modified on feature branch](screenshots/Assignment5-Screenshot4.png)

---

#### Screenshot 5 — Output of `git commit`

![Screenshot 5 - Student list update committed](screenshots/Assignment5-Screenshot5.png)
...
![Screenshot 6 - Feature branch pushed successfully](screenshots/Assignment5-Screenshot6.png)

---

#### Screenshot 7 — Your fork on GitHub showing `feature-readme-update` in the branch selector or a "Compare & pull request" banner

![Screenshot 7 - Feature branch visible on GitHub fork](screenshots/Assignment5-Screenshot7.png)
...
![Screenshot 8 - Pull Request creation page with correct branches](screenshots/Assignment5-Screenshot8.png)

---

#### Screenshot 9 — Successfully created Pull Request page with the PR number visible

![Screenshot 9 - Successfully created Pull Request number 411](screenshots/Assignment5-Screenshot9.png)
...
`https://github.com/pravinmishraaws/devops-micro-internship-interviews/pull/411`
...
`https://www.linkedin.com/posts/share-7486563986931580928-rvVZ/?utm_source=share&utm_medium=member_desktop&rcm=ACoAABp_eQgBPlJcA09mSDh9Dmz_Fnr6k9cADN8`

---

#### Screenshot — LinkedIn post showing your successfully created Pull Request

![LinkedIn post showing the successfully created Pull Request](screenshots/Assignment5-LinkedInPost.png)
...
`https://github.com/MatthewBardi/devops-micro-internship-interviews`
